 ...
 * DAO for table QUN.
*/
public class QunDao extends AbstractDao<Qun, String> {
    ...
    */
    ...
    public QunDao(DaoConfig config) {
        super(config);
    }
    
    public QunDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Qun entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Qun readEntity(Cursor cursor, int offset) {
        Qun entity = new Qun( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Qun entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Qun entity, long rowId) {
        return entity.getQunId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Qun entity) {
        if(entity != null) {
            return entity.getQunId();
        } else {
            return null;
